...
- A whole family of blockers may be gated on the material, the five `synthetic_*` codes applying to a synthetic sample alone: `synthetic_starting_material_missing`, `synthetic_starting_material_composition_missing`, `synthetic_final_product_missing`, `synthetic_synthesis_date_missing`, `synthetic_operator_name_missing` ([[synthetic-details]]).
