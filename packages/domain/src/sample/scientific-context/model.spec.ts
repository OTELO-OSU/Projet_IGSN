...
describe("a person is a link or a typed name, never both", () => {
  it.each([
    {
      case: "a chief scientist linked and named",
      input: {
        provenanceStatus: "field_sample",
    ...
    {
      case: "a chief scientist linked and carrying an ORCID",
      input: {
        provenanceStatus: "field_sample",
        chiefScientistUserId: USER_ID,
        chiefScientistOrcid: "0000-0002-1825-0097",
    ...
    {
      case: "a field-sample collector linked and named",
      input: {
        provenanceStatus: "field_sample",
    ...
    {
      case: "a collection curator linked and named",
      input: {
        provenanceStatus: "collection_specimen",
    ...
    {
      case: "a collection-specimen collector linked and named",
      input: {
        provenanceStatus: "collection_specimen",
        collectorUserId: USER_ID,
        collectorLastname: "von Humboldt",
