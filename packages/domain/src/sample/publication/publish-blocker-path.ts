...
export const PUBLISH_BLOCKER_PATH: Record<PublishBlocker, string | null> = {
  ...
  location_position_missing: "location.position",
  ...
  vertical_position_incomplete: "location.position.vertical",
  existence_status_missing: "existenceStatus",
  availability_status_missing: "availabilityStatus",
  scientific_context_missing: "scientificContext",
