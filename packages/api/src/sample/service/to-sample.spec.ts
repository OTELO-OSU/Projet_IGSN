...
const row = {
  ...
  physiographic_environment: "marine.continental_shelf",
  ...
  sc_collector_user_id: null,
  sc_collector_firstname: null,
  sc_collector_lastname: null,
  sc_funding: null,
  sc_research_program_description: null,
  sc_platform_type: null,
  sc_launch_platform_name: null,
  sc_collection_curator_user_id: null,
  ...
  syn_operator_user_id: null,
  syn_operator_firstname: null,
  syn_operator_lastname: null,
...
describe("toSample", () => {
  it("should map a db row to a domain Sample with camelCase fields", () => {
    ...
    expect(sample).toEqual({
      ...
      physiographicEnvironment: "marine.continental_shelf",
