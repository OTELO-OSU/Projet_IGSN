...
// stdout line so the Playwright side reads their ids and owners. Run inside
// the api container (`pnpm -F @projet-igsn/api seed:e2e`); see
// e2e/support/db.ts. Deleting the samples cascades user_sample.
const db = createDb();
