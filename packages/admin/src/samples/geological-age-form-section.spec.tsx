...
describe("GeologicalAgeFormSection", () => {
  it("should be off by default, hiding the stratigraphic fields", async () => {
  ...
  it("should clear the unit when the block is disabled and re-enabled", async () => {
    await render(<Harness />);
  ...
  it("should clear the fixed age when switching to range and back", async () => {
    await render(<Harness values={{ geologicalAge: "ics1" }} />);
